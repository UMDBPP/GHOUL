 ...
 * circular buffer. Transfer function in z-domain is as follows: G(z) = c_0 +
 * c_1 * z^-1 + ... + c_(N-1) * z^(N-1) Where c_n is the n-th coefficient and N
 * is the filter order.
 *
...
void FIRFilter_Init(FIRFilter *filt, float *coeff, float *buf,
